...
class FeatureGroupEnhance(nn.Module):
    def __init__(self, groups=128,device=None):
        super().__init__()
        self.groups = groups
...
class CalibrationModule:
    ...
    def __init__(self, cfg):
        ...
        self.enhancer = FeatureGroupEnhance(device=self.device)
    ...
    def extract_roi_features(self, img, boxes):
        ...
        enhance_feature = self.enhancer(conv_feature)

        box_features = self.roi_pooler([enhance_feature], boxes).squeeze(2).squeeze(2)
